                                ...
                                <tbody>
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        echo "<tr>
                                                ...
                                                <td>{$row['type']}</td>
                                                <td>
                                                    <a href='edit-user-type.php?id={$row['id']}' class='btn btn-warning btn-sm'>Edit</a>
                                                    <a href='delete-user-type.php?id={$row['id']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure?\")'>Delete</a>
                                                </td>
                                              </tr>";
                                    }
                                    ?>
